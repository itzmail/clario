...
- [x] **SEC-01**: User bisa membuka screen Process Monitor dari dashboard
...
- [x] **SEC-04**: User bisa melihat detail process yang dipilih
- [x] **SEC-05**: User bisa kill process dengan konfirmasi modal
